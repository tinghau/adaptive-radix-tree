...
public class ArtNode16BinarySearchTest extends ArtNodeTest {

    @Override
    public IArtNode<String> getNode(long key) {
        return new ArtNode16BinarySearch<>(key);
    }

    @Override
    public IArtNode<String> getNode(long key, int depth) {
        return new ArtNode16BinarySearch<>(key, depth);
    }
    ...
    public void testArtNode16FromArtNode4() {
        ...
        IArtNode<String> node16 = new ArtNode16BinarySearch<>(node4);
    ...
    public void testArtNode16FromArtNode48() {
        ...
        IArtNode<String> node16 = new ArtNode16BinarySearch<>(node48);
        assertEquals("0", node16.get(779682134L));
